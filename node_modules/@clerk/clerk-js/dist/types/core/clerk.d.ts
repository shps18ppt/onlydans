...
import type { __experimental_AuthenticateWithGoogleOneTapParams, ActiveSessionResource, AuthenticateWithMetamaskParams, Clerk as ClerkInterface, ClerkAPIError, ClerkOptions, ClientResource, CreateOrganizationParams, CreateOrganizationProps, DomainOrProxyUrl, EnvironmentJSON, EnvironmentResource, HandleEmailLinkVerificationParams, HandleOAuthCallbackParams, InstanceType, ListenerCallback, NavigateOptions, OneTapProps, OrganizationListProps, OrganizationProfileProps, OrganizationResource, OrganizationSwitcherProps, SDKMetadata, SetActiveParams, SignInProps, SignInRedirectOptions, SignInResource, SignOut, SignUpProps, SignUpRedirectOptions, SignUpResource, UnsubscribeCallback, UserButtonProps, UserProfileProps, UserResource } from '@clerk/types';
...
export declare class Clerk implements ClerkInterface {
    ...
    __experimental_handleGoogleOneTapCallback: (signInOrUp: SignInResource | SignUpResource, params: HandleOAuthCallbackParams, customNavigate?: ((to: string) => Promise<unknown>) | undefined) => Promise<unknown>;
